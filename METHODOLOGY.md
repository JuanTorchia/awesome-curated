...
- Raw items scraped: 40472
- Curated entries at current threshold: 1182
- Approximate duplicate/raw noise removed: 39290
...
Generated on 2026-09-09 from the juanchi.dev Awesome Curated pipeline. Evidence snapshot: [data/latest.json](data/latest.json).
