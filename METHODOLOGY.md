...
- Raw items scraped: 40895
- Curated entries at current threshold: 1182
- Approximate duplicate/raw noise removed: 39713
...
Generated on 2026-09-18 from the juanchi.dev Awesome Curated pipeline. Evidence snapshot: [data/latest.json](data/latest.json).
