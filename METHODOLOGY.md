...
- Raw items scraped: 40005
- Curated entries at current threshold: 1182
- Approximate duplicate/raw noise removed: 38823
...
Generated on 2026-08-27 from the juanchi.dev Awesome Curated pipeline. Evidence snapshot: [data/latest.json](data/latest.json).
