...
![](https://img.shields.io/github/stars/bayeswitnesses/m2cgen?style=flat-square&label=⭐) · 🔥 **出现在 7 个列表中**
...
**优势:** _Elimina dependencias de runtime de ML en producción: el código generado es nativo y standalone_ · _Soporte genuinamente amplio de lenguajes destino (12+), cubriendo stacks enterprise como Java y C# además de modernos como Go y Dart_
...
![](https://img.shields.io/github/stars/dmlc/xgboost?style=flat-square&label=⭐) · 🔥 **出现在 5 个列表中**
...
**优势:** _Performance excepcional en datos tabulares: históricamente supera a otros algoritmos en benchmarks y competencias reales_ · _Soporte nativo para entornos distribuidos (Spark, Hadoop, Flink) sin cambios mayores en el código_
...
![](https://img.shields.io/github/stars/apache/spark?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _Abstracción limpia memory store_ · _Soporta múltiples backends (vector DB, SQL)_
...
![](https://img.shields.io/github/stars/josephmisiti/awesome-machine-learning?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _Cobertura exhaustiva organizada por lenguaje de programación, útil tanto para pythonistas como para devs de R, Julia o Go_ · _Punto de entrada canónico con décadas de curaduría comunitaria y miles de contribuidores reales_
...
![](https://img.shields.io/github/stars/explosion/spacy?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _Performance alta en C (Cython), listo para producción_ · _Modelos pre-entrenados optimizados y muy documentados_
...
![](https://img.shields.io/github/stars/dlr-rm/stable-baselines3?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _APIs consistentes y bien testeadas_ · _Soporta múltiples backends (Torch, TF, JAX)_
...
![](https://img.shields.io/github/stars/vercel/ai?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _Abstracción consistente entre modelos_ · _Integración perfecta con Next.js_
...
![](https://img.shields.io/github/stars/ashvardanian/numkong?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _SIMD puro sin overhead de binding a C_ · _Soporta múltiples arquitecturas (AVX2, AVX-512, NEON) con fallback automático_
...
![](https://img.shields.io/github/stars/facebookresearch/detectron2?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _SOTA accuracy en coco/benchmarks_ · _Código limpio, extensible, models variados preentrenados_
...
![](https://img.shields.io/github/stars/davisking/dlib?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Composición funcional elegante, vectorization transparente_ · _Performance comparable a TensorFlow en operaciones complejas_
...
![](https://img.shields.io/github/stars/espnet/espnet?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Cobertura completa de pipelines speech_ · _Buena documentación y ejemplos reproducibles_
...
![](https://img.shields.io/github/stars/evidentlyai/evidently?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Reportes interactivos muy claros sobre data drift_ · _Cobertura amplia: tabular, NLP, CV, LLM_
...
![](https://img.shields.io/github/stars/facebookresearch/faiss?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Performance SOTA en búsqueda de k-NN sobre millones de vectores_ · _Índices especializados (HNSW, IVF) con tuning fino_
...
![](https://img.shields.io/github/stars/hybridgroup/gocv?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Binding limpio y completo a OpenCV 4_ · _Performance cercano a C++ nativo sin overhead_
...
![](https://img.shields.io/github/stars/farama-foundation/gymnasium?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _API estable y bien documentada, compatibilidad con 1000+ ambientes_ · _Mantenimiento activo por Farama Foundation, reemplazo directo de Gym con mejoras_
...
![](https://img.shields.io/github/stars/huggingface/tokenizers?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Performance extremo, manejo eficiente de vocabularios grandes_ · _Integración perfecta con transformers HF, bindings Python de primera clase_
...
![](https://img.shields.io/github/stars/interpretml/interpret?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Modelos interpretables por defecto, no post-hoc_ · _Visualizaciones robustas para stakeholders no-técnicos_
...
![](https://img.shields.io/github/stars/jax-ml/jax?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Transformaciones composables superiores a PyTorch_ · _JIT compilation transparente a cualquier backend_
...
![](https://img.shields.io/github/stars/kaldi-asr/kaldi?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Estándar en investigación ASR desde 2010+_ · _Componentes modulares y bien documentados para researchers_
...
![](https://img.shields.io/github/stars/run-llama/llama_index?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integración completa con 50+ data sources y LLMs_ · _Abstracciones de retrieval robustas (query engines)_
...
![](https://img.shields.io/github/stars/milvus-io/milvus?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Self-hosted option viable vs Pinecone SaaS_ · _Escalabilidad y performance demostrada en prod_
...
![](https://img.shields.io/github/stars/ollama/ollama?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Setup one-liner, soporte para decenas de modelos (Llama, Mistral, etc.)_ · _Sin dependencias cloud, control total de datos_
...
![](https://img.shields.io/github/stars/oneapi-src/onednn?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Optimizaciones hardware-specific probadas en producción_ · _Mantenida por Intel, estándar de facto_
...
![](https://img.shields.io/github/stars/optuna/optuna?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Algoritmos avanzados incorporados (TPE, CMA-ES), better than grid search_ · _Distributed ready, integración con Ray/Dask_
...
![](https://img.shields.io/github/stars/huggingface/peft?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Reduce parámetros entrenables en 90%+; compatible con cualquier modelo HF_ · _Comunidad masiva, docs exhaustivas_
...
![](https://img.shields.io/github/stars/yzhao062/pyod?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _50+ algoritmos, desde Isolation Forest a autoencoders_ · _Interfaz sklearn-compatible, integra sin fricción_
...
![](https://img.shields.io/github/stars/openmined/pysyft?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Único framework maduro para privacy-preserving ML en Python_ · _Integración cleancon PyTorch existente_
...
![](https://img.shields.io/github/stars/lightning-ai/pytorch-lightning?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Reduce líneas de código boilerplate en 70%+ sin sacrificar control_ · _Integración nativa con multi-GPU/TPU, logging, checkpoints automáticos_
...
![](https://img.shields.io/github/stars/qdrant/qdrant?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Filtering avanzado (mejor que Pinecone v1)_ · _Cluster distribuido nativo, prod-ready_
...
![](https://img.shields.io/github/stars/idsia/sacred?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Estándar de facto en ML academia_ · _Ecosystem de add-ons maduro_
...
**优势:** _Documentación de oro, API consistente_ · _Ecosistema maduro con miles de ejemplos_
...
![](https://img.shields.io/github/stars/tensorflow/agents?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _APIs consistentes y documentación corporate-grade_ · _Algoritmos RL comprobados (DQN, PPO, DDPG)_
...
![](https://img.shields.io/github/stars/vllm-project/vllm?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _PagedAttention revolucionó memory efficiency_ · _Soporte multi-LoRA y batching dinámico nativo_
...
![](https://img.shields.io/github/stars/vowpalwabbit/vowpal_wabbit?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Performance extremo en datasets masivos y streaming_ · _Soporte único para técnicas avanzadas (learning2search, active learning)_
...
![](https://img.shields.io/github/stars/facebookresearch/wav2letter?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Extremadamente optimizado para speech, dominante en research_ · _Integración con librería flashlight moderna_
...
![](https://img.shields.io/github/stars/ultralytics/ultralytics?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Accuracy/speed tradeoff superior a competencia, muy usado en industry_ · _Soporte robusto para deployment edge con C++_
...
![](https://img.shields.io/github/stars/catboost/catboost?style=flat-square&label=⭐) · 出现在 4 个列表中
...
**优势:** _Manejo nativo de variables categóricas sin preprocesamiento manual, reduciendo leakage y trabajo tedioso_ · _Inferencia rápida con soporte multi-GPU real, útil para producción con volumen alto_ · _API consistente con scikit-learn, lo que facilita integración en pipelines existentes_
...
![](https://img.shields.io/github/stars/feature-engine/feature_engine?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _Garantías exactly-once nativas_ · _Integración con Spark SQL/MLlib_
...
![](https://img.shields.io/github/stars/h2oai/h2o-3?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _AutoML robusto que compite con modelos manuales_ · _Escalado horizontal nativo con HDFS/Spark_
...
![](https://img.shields.io/github/stars/bayeswitnesses/m2cgen?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _Elimina dependencias en runtime: el código generado es standalone, sin necesitar librerías de ML instaladas en producción_ · _Soporte amplio de lenguajes (11+) y modelos clásicos de scikit-learn, XGBoost y LightGBM, cubriendo los casos de uso más comunes_ · _Ideal para entornos restringidos como sistemas embebidos, aplicaciones legacy o servicios donde instalar Python es inviable_
...
![](https://img.shields.io/github/stars/mem0ai/mem0?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _API simple para integrar memoria en agentes_ · _Soporte de múltiples backends (vector DB, SQL)_
...
![](https://img.shields.io/github/stars/scikit-image/scikit-image?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _API Pythonica y bien documentada vs OpenCV C++_ · _Integración perfecta con scipy/numpy ecosystem_
...
![](https://img.shields.io/github/stars/njbrake/agent-of-empires?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integración tmux+git worktrees es elegante_ · _Docker sandboxing nativo evita contaminación_
...
![](https://img.shields.io/github/stars/aimhubio/aim?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Interfaz intuitiva, UI limpia vs Weights&Biases_ · _Opción self-hosted, sin vendor lock-in_
...
![](https://img.shields.io/github/stars/askbudi/roundtable?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Auto-discovery de assistentes sin config_ · _Abstracción elegante sobre MCP fragmentado_
...
![](https://img.shields.io/github/stars/yigtwxx/awesome-rag-production?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Mapeo exhaustivo del ecosistema RAG moderno_ · _Enfoque en aspectos de producción (monitoring, deployment, security)_
...
![](https://img.shields.io/github/stars/bentoml/bentoml?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integra con PyTorch/TF/sklearn sin cambios code_ · _Deployment a cloud (AWS/GCP/Azure) semi-automático_
...
![](https://img.shields.io/github/stars/bread-technologies/bread_wandb_viewer_extension?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Privacy/offline first_ · _Reduce context switching en iteración_
...
![](https://img.shields.io/github/stars/tracel-ai/burn?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _No depende de Python/PyTorch, control total desde Rust_ · _Backend abstraction permite GPU/CPU/WebGPU transparente_
...
![](https://img.shields.io/github/stars/huggingface/candle?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _API simple, sintaxis clara, menos boilerplate que otros frameworks_ · _Soporte GPU maduro (CUDA/Metal), performance competitivo_
...
![](https://img.shields.io/github/stars/catalyst-team/catalyst?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Callbacks y logging robustos para experimentos_ · _Soporte out-of-box para RL y DL research_
...
![](https://img.shields.io/github/stars/liuliu/ccv?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _footprint pequeño_ · _performance optimizado_
...
![](https://img.shields.io/github/stars/chroma-core/chroma?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integración nativa con LangChain y frameworks de IA_ · _API simple y bien documentada para CRUD vectorial_
...
![](https://img.shields.io/github/stars/clearml/clearml?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Cobertura end-to-end impresionante (raro en una tool)_ · _UI intuitiva, setup rápido sin Kubernetes requerido_
...
![](https://img.shields.io/github/stars/ryanbressler/cloudforest?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Performance nativo en Go_ · _Implementación limpia sin dependencias externas_
...
![](https://img.shields.io/github/stars/neolabhq/context-engineering-kit?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Enfoque explícito en eficiencia de tokens_ · _Patterns de ingeniería contexto hand-crafted_
...
**优势:** _Referencia académica impecable, APIs limpias_ · _Performance sólido para tareas clásicas_
...
![](https://img.shields.io/github/stars/rapidsai/cuml?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Aceleración GPU drop-in para algoritmos standard_ · _APIs familiares tipo scikit-learn_
...
**优势:** _Chat nativo + edición en contexto fluida_ · _Generación de código rápida, heredita estabilidad VSCode_
...
![](https://img.shields.io/github/stars/dagger/container-use?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Aislamiento real sin conflictos between agents_ · _Historial de ejecución + acceso terminal_
...
![](https://img.shields.io/github/stars/deap/deap?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Diseño limpio, estructuras de datos transparentes_ · _Integración nativa con multiprocessing y SCOOP_
...
![](https://img.shields.io/github/stars/jolibrain/deepdetect?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Multi-framework support (TF, XGBoost, Caffe)_ · _Performance optimizado, C++ puro_
...
![](https://img.shields.io/github/stars/determined-ai/determined?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integración nativa TensorFlow+PyTorch con HPO sin boilerplate_ · _Model registry y experiment tracking built-in_
...
![](https://img.shields.io/github/stars/stanfordnlp/dspy?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Composabilidad de componentes tipo módulos reutilizables_ · _Buena integración con herramientas de evals_
...
![](https://img.shields.io/github/stars/flashlight/flashlight?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Performance nativa C++, sin overhead Python_ · _Diseño flexible para experimentos research_
...
![](https://img.shields.io/github/stars/sjwhitworth/golearn?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Diseño modular, soporte varios algoritmos, documentación presente_ · _Performance nativa de Go para inference_
...
![](https://img.shields.io/github/stars/gorgonia/gorgonia?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Computación en grafos flexible, soporte para autodiff_ · _Sin dependencias C++ pesadas, integración limpia con Go_
...
![](https://img.shields.io/github/stars/zhenghaoz/gorse?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Pure Go, sin Python overhead_ · _Designed para offline batch processing_
...
![](https://img.shields.io/github/stars/deepset-ai/haystack?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Abstracciones maduras para RAG (retriever-reader)_ · _Integración nativa con Hugging Face y LLMs populares_
...
![](https://img.shields.io/github/stars/logicalclocks/hopsworks?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Feature store dual (batch + online) en un solo producto_ · _Integración nativa con ecosistema Hadoop/Hive_
...
![](https://img.shields.io/github/stars/pytorch/ignite?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Simplifica distributed training sin sacrificar control_ · _Bien integrada con PyTorch ecosystem_
...
**优势:** _Framework Bayesian especializado con APIs claras_ · _Usado en production en virology, information retrieval_
...
![](https://img.shields.io/github/stars/infiniflow/infinity?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Velocidad en C++20 vs Python puro_ · _Full-text + vector search combinado_
...
![](https://img.shields.io/github/stars/google/jax?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Single header/binario, cero dependencies_ · _Algoritmos clásicos optimizados, excelente para producción embebida_
...
![](https://img.shields.io/github/stars/fukuball/jieba-php?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Única opción nativa PHP para segmentación chino_ · _Sin dependencias del sistema_
...
![](https://img.shields.io/github/stars/kagan-sh/kagan?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integración profunda con git worktrees y ciclo de review_ · _Orquestación de múltiples agentes simultáneamente_
...
![](https://img.shields.io/github/stars/keras-team/keras-tuner?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _API minimalista, aprende en 10 minutos_ · _Integración nativa con Keras, sin fricción_
...
![](https://img.shields.io/github/stars/kornia/kornia?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Operaciones geométricas GPU-nativas_ · _Diferenciable end-to-end para vision+learning loops_
...
![](https://img.shields.io/github/stars/langchain-ai/langchain?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Ecosistema gigante de integraciones (OpenAI, Anthropic, Hugging Face)_ · _Abstracción consistente para chains complejos y memory management_
...
![](https://img.shields.io/github/stars/lightly-ai/lightly-train?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Preentrenamiento sin labels reduce tiempo de etiquetado significativamente_ · _Optimizado para producción industrial, no research_
...
![](https://img.shields.io/github/stars/rust-ml/linfa?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Type-safe, zero-cost abstractions_ · _API consistente, bien documentada_
...
![](https://img.shields.io/github/stars/mudler/localai?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Compatible OpenAI, fácil switchear_ · _Support GPU y CPU, bajo overhead_
...
![](https://img.shields.io/github/stars/ludwig-ai/ludwig?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Configuración declarativa YAML, rápido de iterar_ · _Soporta transfer learning y fine-tuning LLMs_
...
![](https://img.shields.io/github/stars/doobidoo/mcp-memory-service?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Consolidación autónoma de memoria sin manual_ · _Multi-client, útil para orquestación de agentes_
...
![](https://img.shields.io/github/stars/mljar/mljar-supervised?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Automatiza feature engineering ahorrando semanas_ · _Reportes HTML de explicabilidad incluidos_
...
![](https://img.shields.io/github/stars/ml-explore/mlx?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Optimizado nativamente para Metal en Macs, rendimiento superior vs PyTorch en ese hardware_ · _Bajo nivel de abstracción, contrario a los framework pesados_
...
![](https://img.shields.io/github/stars/rasbt/mlxtend?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Colección robusta de algoritmos y evaluadores ML_ · _Documentación sólida, comunidad activa_
...
![](https://img.shields.io/github/stars/modal-python/modal?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integración nativa con scikit-learn_ · _API clara para pipelines de active learning_
...
**优势:** _UI limpia e intuitiva_ · _Soporta múltiples formatos (ONNX, SavedModel, etc)_
...
**优势:** _Sesiones paralelas para multi-agent workflows_ · _Integración mockups+código en mismo editor_
...
![](https://img.shields.io/github/stars/comet-ml/opik?style=flat-square&label=⭐) · 出现在 2 个列表中

- Opik is an open-source platform for evaluating, testing and monitoring LLM applications.

> **AI 分析：** Plataforma open-source para evaluar, testear y monitorear aplicaciones LLM. Trazabilidad de prompts y outputs con métricas de evaluación integradas.

**优势:** _Dashboard unificado para debugging de LLM pipelines_ · _Evaluación automática de outputs con criterios personalizados_
...
**优势:** _Trazado granular de LLM chains_ · _Evals automatizadas para reproducibility_
...
![](https://img.shields.io/github/stars/oryxproject/oryx?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integración nativa Spark + Kafka para pipelines reales_ · _Aplicaciones end-to-end listos para ajustar_
...
![](https://img.shields.io/github/stars/pgmpy/pgmpy?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Única librería seria en Python para PGMs_ · _Documentación decente con ejemplos reales_
...
![](https://img.shields.io/github/stars/pycaret/pycaret?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Reduce drasticamente tiempo de baseline a production_ · _Soporte multi-algoritmo out-of-the-box con comparación automática_
...
![](https://img.shields.io/github/stars/guillaume-be/rust-bert?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Zero Python dependency, deploy simple en binarios Rust_ · _Soporta modelos HF populares, descarga automática_
...
![](https://img.shields.io/github/stars/guofei9987/scikit-opt?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Cobertura amplia de algoritmos heurísticos_ · _API consistente entre implementaciones_
...
![](https://img.shields.io/github/stars/sgl-project/sglang?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Throughput 3-10x mejor que vLLM en casos multi-GPU_ · _Soporte para vision models_
...
![](https://img.shields.io/github/stars/maif/shapash?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Visualizaciones muy legibles para ejecutivos y reguladores_ · _Integración cercana con SHAP, reutiliza cálculos_
...
![](https://img.shields.io/github/stars/shogun-toolbox/shogun?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Soporte exhaustivo de algoritmos clásicos ML_ · _Performance nativa C++, productizable_
...
![](https://img.shields.io/github/stars/yusufkaraaslan/skill_seekers?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _17 fuentes soportadas en una herramienta_ · _Exporta a 5+ vector DBs (Weaviate, Chroma, FAISS, Qdrant)_
...
![](https://img.shields.io/github/stars/skorch-dev/skorch?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Compatibilidad directa con sklearn pipelines/validación cruzada_ · _Reduce boilerplate PyTorch manteniendo flexibilidad_
...
![](https://img.shields.io/github/stars/nlpodyssey/spago?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Zero dependencies, embebible en aplicaciones Go_ · _Performance competitivo en tareas NLP clásicas_
...
![](https://img.shields.io/github/stars/spfunctions/simplefunctions-cli?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Datos de 9700+ mercados, sin autenticación requerida_ · _Output estructurado y calibrado para LLMs_
...
![](https://img.shields.io/github/stars/obra/superpowers?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Cobertura amplia del ciclo de vida completo_ · _Bien organizado y adaptable a contextos específicos_
...
![](https://img.shields.io/github/stars/diyago/tabular-data-generation?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Múltiples backends (GAN, diffusion, LLM)_ · _Métricas de privacidad y sklearn-compatible_
...
![](https://img.shields.io/github/stars/laurentmazare/tch-rs?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Acceso directo a PyTorch performance desde Rust_ · _Sintaxis cercana a PyTorch, curva aprendizaje menor_
...
![](https://img.shields.io/github/stars/tensorzero/tensorzero?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Unifica inference, evals y feedback en una interfaz_ · _Buena integración con providers (OpenAI, Anthropic)_
...
![](https://img.shields.io/github/stars/epistasislab/tpot?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Automatiza feature engineering y selección de algoritmos_ · _Generación explícita de código Python ejecutable_
...
![](https://img.shields.io/github/stars/unslothai/unsloth?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Realmente reduce VRAM 60-70% con optimizaciones de kernel personalizadas_ · _Activamente mantenido, comunidad creciente en Hugging Face_
...
![](https://img.shields.io/github/stars/unum-cloud/usearch?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Soporte nativo para strings y vectores en mismo engine_ · _Bindings en múltiples lenguajes_
...
**优势:** _Interfaz VSCode hace rampa de entrada baja para usuarios existentes_ · _AI chat decente para sugerencias inline_
...
![](https://img.shields.io/github/stars/aksnzhy/xlearn?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Excelente rendimiento en datasets sparse de alta dimensión_ · _API simple para problemas de clasificación y ranking a escala_
...
![](https://img.shields.io/github/stars/zenml-io/zenml?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Metadata tracking y caching built-in reduce overhead_ · _Flexible: soporta múltiples orquestadores y backends_
