...
![](https://img.shields.io/github/stars/ray-project/ray?style=flat-square&label=⭐) · 出现在 3 个列表中
...
![](https://img.shields.io/github/stars/ansible/ansible?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/borgbackup/borg?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/google/cadvisor?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Integración nativa con Prometheus: expone métricas listas para scraping sin configuración compleja_ · _Respaldado y mantenido por Google, ampliamente probado en entornos de producción a escala_ · _Granularidad por contenedor: CPU, memoria, red y filesystem con historial de rendimiento_
...
![](https://img.shields.io/github/stars/iterative/cml?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/microsoft/docker.dotnet?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/derailed/k9s?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/unitech/pm2?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/saltstack/salt?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/secdev/scapy?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/containous/traefik?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/dragonflyoss/dragonfly2?style=flat-square&label=⭐) · 出现在 3 个列表中
...
![](https://img.shields.io/github/stars/imsnif/bandwhich?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/bcicen/ctop?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/deployphp/deployer?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/wagoodman/dive?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/offen/docker-volume-backup?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/lirantal/dockly?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/domcyrus/rustnet?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/drone/drone?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/dromara/hertzbeat?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/jesseduffield/lazydocker?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/lifailon/lazyjournal?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/localtunnel/localtunnel?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/spotify/luigi?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/jason5ng32/myip?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/netdata/netdata?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/nwiizo/tfmcp?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/orhun/rustypaste?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/mrjackwills/oxker?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/prefecthq/prefect?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/ignisda/ryot?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/peak/s5cmd?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/sintan1729/chhoto-url?style=flat-square&label=⭐) · 出现在 2 个列表中
...
![](https://img.shields.io/github/stars/sshuttle/sshuttle?style=flat-square&label=⭐) · 出现在 2 个列表中
