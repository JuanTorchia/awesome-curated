...
**优势:** _Cobertura criptográfica exhaustiva y bien auditada_ · _Compatibilidad JCA nativa, integración directa con ecosistema Java_
...
![](https://img.shields.io/github/stars/briansmith/ring?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Safety guarantees de Rust + auditoría BoringSSL_ · _Performance sin sacrificar seguridad_
...
![](https://img.shields.io/github/stars/weidai11/cryptopp?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Amplia cobertura de esquemas criptográficos_ · _Maduro y auditado_
...
**优势:** _Integración transparente con cloud providers_ · _Zero-knowledge por diseño_
...
**优势:** _Cobertura exhaustiva de técnicas google search_ · _Gratuito y mantenido activamente_
...
**优势:** _Estándar industria de 25+ años_ · _Zero-dependency, CLI portable y ubiquo_
...
![](https://img.shields.io/github/stars/rustcrypto/hashes?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Auditoría de seguridad profesional (RustCrypto)_ · _Cobertura completa de algoritmos modernos_
...
**优势:** _Soporte multi-protocolo robusto (OIDC, SAML, LDAP)_ · _Cluster-ready y escalable horizontalmente_
...
![](https://img.shields.io/github/stars/jedisct1/libsodium?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _API opinionada reduce errores de uso_ · _Ampliamente auditada y confiable_
...
**优势:** _Amplio coverage de checks de seguridad_ · _Output estructurado, integrable en pipelines_
...
![](https://img.shields.io/github/stars/openssl/openssl?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Estándar de facto en todas partes (sistemas, apps, servicios)_ · _Auditoría y madurez incomparables_
...
![](https://img.shields.io/github/stars/pyca/pynacl?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _API clara y segura por defecto, difícil hacerla mal_ · _Basada en NaCl auditada y battle-tested_
...
![](https://img.shields.io/github/stars/awslabs/s2n?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Auditorías de seguridad regulares y mantenimiento activo_ · _Optimizaciones de performance específicas para SSL/TLS_
...
![](https://img.shields.io/github/stars/safedep/vet?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Local execution sin cloud dependency_ · _Coverage dual npm/PyPI con scanning de malware_
...
![](https://img.shields.io/github/stars/danielmiessler/seclists?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Cobertura exhaustiva: fuzzing, credenciales, patrones_ · _Actualización activa y comunidad robusta_
...
**优势:** _Base de datos masiva de dispositivos indexados_ · _Filtros avanzados (puerto, banner, geolocalización)_
...
![](https://img.shields.io/github/stars/trustedsec/social-engineer-toolkit?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Ataques preseteados realistas y probados_ · _Integración con Metasploit, payloads customizables_
...
**优势:** _Automatización masiva reduce manual work 70%+_ · _Modular y extensible, open source_
...
![](https://img.shields.io/github/stars/sqlmapproject/sqlmap?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Automatización extremadamente efectiva, soporta casi todos los tipos de BD_ · _Actualización constante vs nuevas técnicas de obfuscación_
...
![](https://img.shields.io/github/stars/anchore/syft?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Herramienta en ecosistema maduro (supply-chain security), requisito creciente en enterprise_ · _Activa, open-source, usada en industry_
...
**优势:** _Integración transparente de Tor en toda la stack_ · _Amnesia forzada, no hay persistencia accidental_
...
![](https://img.shields.io/github/stars/google/tink?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _APIs imposibles de misuser por diseño_ · _Soporte multi-lenguaje + plataforma_
...
**优势:** _Red más grande y auditada en privacidad_ · _Triple encriptación, protección contra análisis de tráfico comprobada_
...
![](https://img.shields.io/github/stars/dani-garcia/vaultwarden?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Consumo RAM/CPU mínimo comparado a versión oficial_ · _Deployable en VPS barato sin overhead_
...
**优势:** _Base de datos masiva de firmas de 90+ motores_ · _Acceso gratuito sin límites aparentes, API disponible_
...
![](https://img.shields.io/github/stars/briansmith/webpki?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Validación correcta de certificados sin C deps_ · _Auditoría profesional, usado en producción crítica_
...
![](https://img.shields.io/github/stars/cossacklabs/themis?style=flat-square&label=⭐) · 🔥 **出现在 7 个列表中**
...
![](https://img.shields.io/github/stars/paralax/awesome-honeypots?style=flat-square&label=⭐) · 出现在 3 个列表中
...
**优势:** _Cobertura completa de tipos honeypot_ · _Facilita deployment defensivo_
...
![](https://img.shields.io/github/stars/splx-ai/agentic-radar?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Soporte multi-framework, case de uso urgente (seguridad agentic)_ · _Output visualizable e insights accionables_
...
**优势:** _Feature-complete, soporta realm-based auth_ · _Integración simple en apps Java/JVM existentes_
...
**优势:** _C++20 native, code moderno_ · _Cobertura amplia de algoritmos post-quantum_
...
**优势:** _Built-in ad/tracker blocking_ · _Updates respetan preferencias user_
...
![](https://img.shields.io/github/stars/krzyzanowskim/cryptoswift?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Pure Swift, portable entre plataformas_ · _API clara y docs decentes_
...
**优势:** _Interfaz web simple_ · _Rápido para queries ocasionales_
...
**优势:** _Protocolo abierto federated, no lock-in_ · _E2E encryption por defecto, auditable_
...
**优势:** _1-line install, setup trivial vs OpenVPN, GUI intuitiva_ · _WireGuard más eficiente y moderno que IPSec/OpenVPN_
...
**优势:** _Precisión alta en email validation_ · _API y bulk processing disponibles_
...
**优势:** _Arquitectura totalmente descentralizada sin directory servers_ · _Resistente a ataques de correlación de tráfico_
...
**优势:** _Integración con verificación de identidad criptográfica_ · _Chat y archivos en un único ecosistema_
...
![](https://img.shields.io/github/stars/kpcyrd/authoscope?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Escritura en Rust garantiza seguridad de memoria_ · _Scriptable para automatizar pruebas de autenticación_
...
![](https://img.shields.io/github/stars/kpcyrd/sniffglue?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Seguridad de memoria garantizada por Rust_ · _Multithreading nativo sin race conditions_
...
**优势:** _Telemetría completamente removida_ · _Compilación reproducible_
...
**优势:** _Visualización excepcional de conexiones entre entidades_ · _Cientos de transforms para datasources_
...
![](https://img.shields.io/github/stars/mariocandela/beelzebub?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Enfoque novel: usar herramientas carnada como signal de compromiso en agentes_ · _Integración con MCP standard para extensibilidad_
...
![](https://img.shields.io/github/stars/mavdol/capsule?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Isolación real via WASM, sin escape path obvio_ · _Soporte dual Python/JavaScript_
...
![](https://img.shields.io/github/stars/ockam-network/ockam?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Abstracciones portables para transporte (TCP, UDP, Bluetooth)_ · _Modelo de seguridad auditado para comms distribuidas_
...
![](https://img.shields.io/github/stars/orion-rs/orion?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _API deliberadamente difícil de misusar, errores en compile-time_ · _Documentación clara con ejemplos de misuso común_
...
**优势:** _E2E encryption nativo_ · _Historial preservado_
...
![](https://img.shields.io/github/stars/promptfoo/promptfoo?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Cubre vectores de ataque específicos de LLMs_ · _CI/CD integration out-of-box_
...
![](https://img.shields.io/github/stars/str4d/rage?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Interfaz minimalista, sin opciones inseguras_ · _Rápido, código limpio y auditable_
...
![](https://img.shields.io/github/stars/redlib-org/redlib?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Zero JavaScript, performance_ · _Privacy-focused, open source_
...
![](https://img.shields.io/github/stars/kpcyrd/rshijack?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Implementación limpia en Rust de técnica clásica_ · _Mantenimiento activo por kpcyrd_
...
![](https://img.shields.io/github/stars/sherlock-project/sherlock?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Setup trivial, útil para auditorías rápidas de availability de usernames_ · _Soporta muchas plataformas_
...
![](https://img.shields.io/github/stars/ssh-vault/ssh-vault?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Cero dependencias externas, aprovecha claves SSH existentes_ · _Muy simple de usar, overhead mínimo_
...
![](https://img.shields.io/github/stars/jedisct1/swift-sodium?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Acceso a libsodium battle-tested; AEAD + key derivation_ · _Mantenimiento activo, usado en prod_
...
![](https://img.shields.io/github/stars/laramies/theharvester?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Agregador maduro de múltiples fuentes públicas_ · _Baja curva de entrada, output útil inmediato_
...
![](https://img.shields.io/github/stars/trailofbits/skills?style=flat-square&label=⭐) · 出现在 2 个列表中
...
**优势:** _Creado por referentes en security (Trail of Bits)_ · _Cubre análisis estático, variante y code review diferencial_
...
**优势:** _Cobertura global con aporte comunitario_ · _Herramienta propia para captura de datos_
...
**优势:** _UI moderna vs OllyDbg antiguo_ · _Breakpoints avanzados, plugin ecosystem activo_
