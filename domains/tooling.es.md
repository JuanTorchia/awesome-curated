# 🧰 Herramientas Dev — Awesome Curated

<p><sub>← [Volver al main](../README.es.md)</sub></p>

**54 GEMs · 97 Vale probar**
...
![](https://img.shields.io/github/stars/pytorch/pytorch?style=flat-square&label=⭐) · 🔥 **aparece en 6 listas**
...
**Fortalezas:** _API pythónica e imperativa (define-by-run) que facilita debugging y experimentación frente a enfoques de grafo estático_ · _Ecosistema gigante: torchvision, torchaudio, HuggingFace, Lightning y miles de papers con implementaciones oficiales en PyTorch_ · _Soporte nativo de GPU vía CUDA con autograd automático, reduciendo la complejidad de implementar backpropagation custom_
...
![](https://img.shields.io/github/stars/sindresorhus/awesome-nodejs?style=flat-square&label=⭐) · aparece en 4 listas
...
> **Análisis IA:** PKM basado en Markdown local. Para investigadores, escritores, developers que necesitan conectar ideas sin vendor lock-in. Resuelve el problema de organización flexible sin cloud obligatorio.

**Fortalezas:** _Graph de notas sin fricción, completamente local_ · _Plugin ecosystem robusto para extender funcionalidad_
...
![](https://img.shields.io/github/stars/microsoft/playwright?style=flat-square&label=⭐) · aparece en 4 listas
...
**Fortalezas:** _Soporte nativo para Chromium, Firefox y WebKit con una sola API coherente, sin parches ni wrappers_ · _Ejecución de tests en paralelo out-of-the-box con aislamiento por contexto de browser, sin configuración compleja_ · _Auto-wait integrado que elimina la mayoría de los flaky tests por timing sin agregar sleeps manuales_
...
**Fortalezas:** _Código abierto auditado, E2E encryption_ · _Self-hosting option + cloud oficial_
...
![](https://img.shields.io/github/stars/iterative/dvc?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/jupyter/notebook?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/kubernetes/kubernetes?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/microsoft/lightgbm?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/moby/moby?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/pyg-team/pytorch_geometric?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/scikit-learn/scikit-learn?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/sympy/sympy?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/huggingface/transformers?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/ajeetdsouza/zoxide?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/astral-sh/ruff?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/cookiecutter/cookiecutter?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/cypress-io/cypress?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/bootandy/dust?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/junegunn/fzf?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/ocornut/imgui?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/markusschanta/awesome-jupyter?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/micropython/micropython?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/mitmproxy/mitmproxy?style=flat-square&label=⭐) · aparece en 2 listas
...
> **Análisis IA:** Proxy HTTP/HTTPS interactivo para testing y pentesting. Herramienta de facto en seguridad. Resuelve debugging de requests HTTPS e inspection de tráfico.

**Fortalezas:** _TLS termination interactivo_ · _API programática + web UI_
...
![](https://img.shields.io/github/stars/python/mypy?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/neon-bindings/neon?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/nodejs/node?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/openapitools/openapi-generator?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/pytest-dev/pytest?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/rustdesk/rustdesk?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/mozilla/sccache?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/christian-bromann/awesome-selenium?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/sharkdp/bat?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/sharkdp/fd?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/bokeh/bokeh?style=flat-square&label=⭐) · aparece en 4 listas
...
![](https://img.shields.io/github/stars/gyulyvgc/sniffnet?style=flat-square&label=⭐) · aparece en 4 listas
...
![](https://img.shields.io/github/stars/cake-build/cake?style=flat-square&label=⭐) · aparece en 3 listas
...
**Fortalezas:** _DSL en C# permite reutilizar logica de compilación sin shell script, más type-safe_ · _Integración nativa con NuGet y ecosystem .NET sin plugins externos_
...
![](https://img.shields.io/github/stars/hpcaitech/colossalai?style=flat-square&label=⭐) · aparece en 3 listas
...
> **Análisis IA:** Framework distribuido para entrenamiento/inferencia de LLMs grandes. Optimizaciones para multi-GPU, tensor parallelism. Para MLOps que entrenan modelos propios.

**Fortalezas:** _Optimizaciones specific para big models (tensor/pipeline parallelism)_ · _Integration con HF transformers_
...
![](https://img.shields.io/github/stars/deepchecks/deepchecks?style=flat-square&label=⭐) · aparece en 3 listas
...
**Fortalezas:** _Cobertura integral: data checks, model validation, drift detection en un solo lugar_ · _Integración práctica con workflows reales (notebooks, CI/CD, production monitoring)_
...
![](https://img.shields.io/github/stars/lasantosr/intelli-shell?style=flat-square&label=⭐) · aparece en 3 listas
...
**Fortalezas:** _Escrito en Rust: binario rápido y sin dependencias runtime_ · _Búsqueda fuzzy y placeholders parametrizables hacen reutilización flexible_
...
![](https://img.shields.io/github/stars/ivanilves/lstags?style=flat-square&label=⭐) · aparece en 3 listas

Tool and API to sync Docker images across different registries.

> **Análisis IA:** CLI + API para sincronizar imágenes Docker entre registries (Docker Hub, ECR, GCR, etc). Para DevOps/SREs que necesitan replicar imágenes. Resuelve: evitar vendor lock-in de registries.

**Fortalezas:** _Simple, hace una cosa bien_ · _Paralelización de pulls/pushes_
...
![](https://img.shields.io/github/stars/mochajs/mocha?style=flat-square&label=⭐) · aparece en 3 listas
...
**Fortalezas:** _Sintaxis clara, fácil de leer para no-especialistas_ · _Integración directa con CI/CD sin configuración compleja_
...
![](https://img.shields.io/github/stars/octolinker/browser-extension?style=flat-square&label=⭐) · aparece en 3 listas
...
**Fortalezas:** _Zero-config, activa automáticamente en GH_ · _Soporta monorepos y path mappings_
...
![](https://img.shields.io/github/stars/peachpiecompiler/peachpie?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/polyaxon/polyaxon?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/pymc-devs/pymc?style=flat-square&label=⭐) · aparece en 3 listas
...
![](https://img.shields.io/github/stars/readest/readest?style=flat-square&label=⭐) · aparece en 3 listas
...
**Fortalezas:** _Binaries livianos, sin Electron overhead_ · _Buena integración con formatos estándar (EPUB, PDF)_
...
**Fortalezas:** _Refactoring automático enterprise-grade_ · _Debugging y profiling integrados sin plugins_
...
![](https://img.shields.io/github/stars/wavetermdev/waveterm?style=flat-square&label=⭐) · aparece en 3 listas
...
**Fortalezas:** _UI moderna y responsive comparado con tmux/screen_ · _Web browsing integrado es genuinamente útil_
...
![](https://img.shields.io/github/stars/yt-dlp/yt-dlp?style=flat-square&label=⭐) · aparece en 3 listas
...
> **Análisis IA:** Descargador de videos robusto que reemplazó youtube-dl. Tira video + metadata desde casi cualquier plataforma. Resuelve problem real: archivado y análisis de contenido multimedia.

**Fortalezas:** _Coverage absurdo de plataformas (YouTube, Twitch, TikTok, etc)_ · _Desarrollo muy activo con fixes constantes_
...
**Fortalezas:** _Completamente local, no envía datos a servidores_ · _Extensible via plugins y webhook_
...
![](https://img.shields.io/github/stars/koriyoshi2041/agentify?style=flat-square&label=⭐) · aparece en 2 listas
...
> **Análisis IA:** Genera 9 formatos de agent interfaces desde OpenAPI specs con un comando. Útil para workflows que requieren múltiples integraciones AI pero muy específico.

**Fortalezas:** _Soporte a 9 formatos en un comando_ · _Estrategias tiered para APIs chicas y grandes_
...
![](https://img.shields.io/github/stars/pmusolino/ai-git-narrator?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Ahorra tiempo en escritura repetitiva de commits_ · _Mejora consistencia en messages_
...
**Fortalezas:** _Stack multiplataforma robusto (Rust backend)_ · _AGPL permite self-hosting sin restricciones comerciales_
...
![](https://img.shields.io/github/stars/ashvardanian/stringzilla?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Aceleración real en x86/ARM, benchmarks sólidos_ · _Bindings para múltiples lenguajes_
...
![](https://img.shields.io/github/stars/ast-grep/ast-grep?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Velocidad nativa en Rust, manejo correcto de AST vs regex_ · _Sintaxis de queries amigable para búsquedas complejas_
...
![](https://img.shields.io/github/stars/julien-cpsn/atac?style=flat-square&label=⭐) · aparece en 2 listas

A feature-full TUI API client made in Rust. ATAC is free, open-source, offline and account-less.

> **Análisis IA:** TUI API client en Rust tipo Postman pero terminal. Offline, funciona sin cuenta. Para devs que pasan vida en terminal y odian UIs pesadas con propagandas.

**Fortalezas:** _Completamente offline y funcional_ · _Performance y UX superior a herramientas web pesadas_
...
![](https://img.shields.io/github/stars/unixorn/awesome-zsh-plugins?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/nikolassv/bartib?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Binario compilado, cero dependencias runtime_ · _Formato JSON humano-legible, fácil scripting_
...
> **Análisis IA:** Build system multi-lenguaje de Google. Velocidad y escalabilidad superiores. Curva empinada pero estándar en monorepos grandes. Open source.

**Fortalezas:** _Performance 10x+ vs Make/Maven en builds incrementales_ · _Cache distribuido y reproducibilidad garantizada_
...
![](https://img.shields.io/github/stars/tmrts/boilr?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Escrito en Go, arranque instantáneo_ · _Simple y directo, sin dependencias pesadas_
...
![](https://img.shields.io/github/stars/canop/broot?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Rendimiento rápido en directorios grandes_ · _Interfaz intuitiva para navegación rápida_
...
![](https://img.shields.io/github/stars/facebook/buck2?style=flat-square&label=⭐) · aparece en 2 listas

Encourages the creation of small, reusable modules consisting of code and resources.

> **Análisis IA:** Build system de Facebook basado en módulos reusables. Competidor a Bazel/Gradle/Turborepo. Para monorepos medianos; complejidad comparable a rivals.

**Fortalezas:** _Incremental builds muy rápido_ · _Rust → mejor rendimiento memory/speed que alternatives JVM_
...
![](https://img.shields.io/github/stars/mixn/carbon-now-cli?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Workflow integrado sin browser_ · _Output visualmente consistente_
...
**Fortalezas:** _Análisis semántico muy preciso para C++_ · _Debugger integrado profesional_
...
![](https://img.shields.io/github/stars/boeing/config-file-validator?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Múltiples formatos soportados_ · _Mantenido por empresa seria (Boeing)_
...
**Fortalezas:** _Bajo rate de falsos positivos, basado en análisis real de código_ · _Sin dependencias externas, rápido de ejecutar_
...
![](https://img.shields.io/github/stars/mono/cppsharp?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Automatiza generación de bindings reduciendo boilerplate_ · _Soporte multiplataforma (Windows, Linux, macOS)_
...
![](https://img.shields.io/github/stars/create-go-app/cli?style=flat-square&label=⭐) · aparece en 2 listas
...
> **Análisis IA:** Navegador offline de docs API para macOS. 200+ frameworks indexados. Búsqueda instantánea sin red. Herramienta dev premium que paga sola en horas ahorradas, pero macOS-only.

**Fortalezas:** _Búsqueda subsecond en 200+ docsets_ · _Integración con IDEs (Xcode, VS Code vía snippets)_
...
![](https://img.shields.io/github/stars/imsnif/diskonaut?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Interfaz TUI responsiva y fluida_ · _Navegación y análisis más ágil que herramientas shell puras_
...
![](https://img.shields.io/github/stars/dotenv-linter/dotenv-linter?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Binario Rust: ultra rápido_ · _Checks prácticos (.env validity, duplicates)_
...
![](https://img.shields.io/github/stars/mifi/editly?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/arogozhnikov/einops?style=flat-square&label=⭐) · aparece en 2 listas

- Flexible and powerful tensor operations for readable and reliable code.

> **Análisis IA:** Librería Python para tensor reshaping/slicing con sintaxis readable. Resuelve problema real: operaciones tensor sin broadcasting confusion. Alternativa a NumPy puro.

**Fortalezas:** _Sintaxis Einstein-notation super legible y correcta_ · _Compatible con PyTorch, TensorFlow, JAX backend-agnostic_
...
![](https://img.shields.io/github/stars/mk-5/fjira?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Interfaz responsiva y fuzzy search fluido_ · _Reduce context switching desde terminal_
...
![](https://img.shields.io/github/stars/sindresorhus/fkill-cli?style=flat-square&label=⭐) · aparece en 2 listas

Fabulously kill processes. Cross-platform.

> **Análisis IA:** Kill procesos por nombre/patrón cross-platform. Resuelve UX horrible de `kill -9`. Lightweight, Sindre Sorhus quality. Útil para devs que no quieren Task Manager.

**Fortalezas:** _Interfaz interactiva y confirmación clara_ · _Cross-platform sin inconsistencias_
...
**Fortalezas:** _Self-hosted y open-source con múltiples licencias_ · _Soporte multiplataforma (desktop + web) desde el mismo código base_
...
![](https://img.shields.io/github/stars/antonmedv/fx?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Interfaz interactiva fluida, binario tiny (~6MB)_ · _Búsqueda y filtrado intuitivo vs jq puro_
...
![](https://img.shields.io/github/stars/moshebe/gebug?style=flat-square&label=⭐) · aparece en 2 listas
...
> **Análisis IA:** Debugging + hot-reload para Go en Docker. Integra Delve debugger sin perder iteración de desarrollo. Útil para workflows local-as-prod.

**Fortalezas:** _hot-reload sin restart manual_ · _Delve integrado_
...
![](https://img.shields.io/github/stars/bmf-san/ggc?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _búsqueda incremental fluida_ · _keybindings customizables_
...
**Fortalezas:** _Stacked branches + undo infinito elimina rebase pain_ · _Agent integrations reducen manual rebasing_
...
> **Análisis IA:** Git GUI más popular: visualización ramas, merge intuitivo, integración GitHub/GitLab/Bitbucket. Freemium, funcionalidad base sólida pero pro features son pago.

**Fortalezas:** _Visualización DAG Git impecable, UX fluida_ · _Integración múltiples plataformas (GitHub, GitLab, Bitbucket)_
...
**Fortalezas:** _Customización sin límites (lenguaje vivo)_ · _Comunidad zealot con recursos avanzados_
...
![](https://img.shields.io/github/stars/pemistahl/grex?style=flat-square&label=⭐) · aparece en 2 listas

A command-line tool and library for generating regular expressions from user-provided test cases

> **Análisis IA:** Genera regex a partir de test cases. Resuelve problema real (auto-generar patterns), útil para one-offs pero no es estándar de industria.

**Fortalezas:** _Simplifica regex creation para non-experts_ · _Rust puro, performante_
...
![](https://img.shields.io/github/stars/helix-editor/helix?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Bindings sensatos por defecto vs Vim vanilla_ · _LSP integrado, zero-config para muchos lenguajes_
...
![](https://img.shields.io/github/stars/httpie/httpie?style=flat-square&label=⭐) · aparece en 2 listas
...
> **Análisis IA:** CLI HTTP client amigable para APIs REST. Reemplaza curl con sintaxis legible y coloreo automático. Excelente para desarrollo, testing manual y documentación de requests.

**Fortalezas:** _Sintaxis intuitiva, salida formateada por defecto_ · _Instalación trivial, cero configuración inicial_
...
**Fortalezas:** _Cobertura 60+ lenguajes sin instalar_ · _URL shareable para collaboration_
...
![](https://img.shields.io/github/stars/facebook/infer?style=flat-square&label=⭐) · aparece en 2 listas

Modern static analysis tool for verifying the correctness of code.

> **Análisis IA:** Static analysis de Facebook para verificar correctitud: null pointers, data races, memory leaks. Para equipos que necesitan análisis automático profundo sin tuning excesivo.

**Fortalezas:** _Detecta bugs reales que otros pierde (data races, leaks)_ · _Bajo ratio de false positives comparado con competition_
...
![](https://img.shields.io/github/stars/smoren/itertools-ts?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Soporte nativo de async iterables, raro en ecosistema JS_ · _Lazy evaluation evita materializar colecciones grandes_
...
![](https://img.shields.io/github/stars/bytedeco/javacpp?style=flat-square&label=⭐) · aparece en 2 listas

The missing bridge between Java and native C++. [Apache2]

> **Análisis IA:** Framework JNI robusto para invocar C++ desde Java. Para equipos que necesitan performance crítica desde JVM sin reescribir en C++. Mejor mantenimiento que JNI puro pero menos usado que SWIG.

**Fortalezas:** _Sintaxis limpia respecto a JNI nativo_ · _Deployment simplificado con librerías precompiladas_
...
**Fortalezas:** _Sync descentralizado (Nextcloud), no vendor lock-in_ · _Encriptación end-to-end opcional integrada_
...
![](https://img.shields.io/github/stars/casey/just?style=flat-square&label=⭐) · aparece en 2 listas

A handy command runner for project-specific tasks

> **Análisis IA:** Task runner moderno que reemplaza Makefiles. Define comandos en justfile, ejecuta localmente o en CI/CD. Útil para equipos que necesitan consistencia en workflows sin overhead.

**Fortalezas:** _Sintaxis limpia y legible vs Makefiles_ · _Excelente integración en proyectos existentes sin cambiar estructura_
...
**Fortalezas:** _Generación automática de parsers multiplataforma desde spec única_ · _Web IDE integrada para testing interactivo_
...
**Fortalezas:** _Integración perfecta con Qt_ · _Debugger robusto, refactoring avanzado_
...
![](https://img.shields.io/github/stars/kreuzberg-dev/kreuzberg?style=flat-square&label=⭐) · aparece en 2 listas
...
> **Análisis IA:** Librería Rust para extracción de documentos. Soporta 62+ formatos con OCR. Resuelve problema real: parsear documents heterogéneos sin invocar mil herramientas. Reciente, promisorio.

**Fortalezas:** _Cobertura amplía de formatos en single library_ · _Núcleo Rust promete performance vs. tools basadas en Python/Java_
...
![](https://img.shields.io/github/stars/largemodgames/spotatui?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Streaming nativo sin dependencias externas pesadas_ · _Visualización de audio en vivo con baja latencia_
...
> **Análisis IA:** REPL interactivo para C#/VB/F#. Ejecuta código al instante, query LINQ against DBs. Pago. Herramienta niche pero potentísima para desarrolladores .NET explorando datos.

**Fortalezas:** _Ejecución instant de C#, sin boilerplate_ · _LINQ queries directas contra DBs, debugging visual_
...
![](https://img.shields.io/github/stars/linus-mussmaecher/rucola?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Escribir/organizar notas sin dejar terminal_ · _Rápido, sin dependencias pesadas_
...
![](https://img.shields.io/github/stars/mifi/lossless-cut?style=flat-square&label=⭐) · aparece en 2 listas
...
![](https://img.shields.io/github/stars/axllent/mailpit?style=flat-square&label=⭐) · aparece en 2 listas

An email and SMTP testing tool for developers.

> **Análisis IA:** SMTP mock server en Go para testing email. Ligero, rápido, con web UI. Estándar para dev loops que requieren testing de emails sin spam real.

**Fortalezas:** _Binario único, cero dependencias_ · _Web UI limpia para inspeccionar mails_
...
**Fortalezas:** _Diseño moderno y UX pulido_ · _Desarrollo activo con releases regulares_
...
![](https://img.shields.io/github/stars/marimo-team/marimo?style=flat-square&label=⭐) · aparece en 2 listas

- Reactive Python notebook — run reproducible experiments, execute as a script, deploy as an app, and version with git.

> **Análisis IA:** Notebook Python reactivo, ejecutable como script y deployable como web app. Versionable con git. Alternativa moderna a Jupyter.

**Fortalezas:** _Reactividad automática (no kernel async confuso)_ · _Export a script y app web sin cambios de código_
...
![](https://img.shields.io/github/stars/marktext/marktext?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Preview en vivo impecable, UX intuitiva para no-devs_ · _Export múltiples formatos, themes customizables_
...
**Fortalezas:** _Setup zero-config, intuitivo para usuarios que vienen de VS Code_ · _Muy rápido, footprint bajo_
...
![](https://img.shields.io/github/stars/microsoft/markitdown?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Conversión multi-formato (PDF, DOCX, Excel, images) a Markdown_ · _Microsoft backing, mantenimiento activo_
...
**Fortalezas:** _Zero-config mocking, UI intuitiva_ · _Exporta requests/responses, compatible con Postman_
...
![](https://img.shields.io/github/stars/dotnet/interactive?style=flat-square&label=⭐) · aparece en 2 listas

- .NET Interactive takes the power of .NET and embeds it into your interactive experiences.

> **Análisis IA:** .NET embebido en notebooks/REPL interactivos. Para data scientists .NET-istas prototipando, teaching. Buena integración con Jupyter pero ecosistema fragmentado.

**Fortalezas:** _Integración nativa con C# type-safety en notebooks_ · _Soporte para Markdown + visualización inline_
...
![](https://img.shields.io/github/stars/immediate-mode-ui/nuklear?style=flat-square&label=⭐) · aparece en 2 listas

A single-header ANSI C gui library. [PublicDomain]

> **Análisis IA:** Single-header GUI en C puro con immediate-mode. Bueno para tools internas, game UI, prototipado rápido. Curva corta, flexible.

**Fortalezas:** _Archivo único, sin dependencias externas_ · _Paradigma immediate-mode es rápido para UIs dinámicas_
...
![](https://img.shields.io/github/stars/nushell/nushell?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Piping de estructuras (JSON, tablas) nativo sin conversión_ · _Sintaxis limpia y debugging intuitivo vs bash arcano_
...
**Fortalezas:** _Cero setup, 70+ idiomas_ · _Compartir código via link directo_
...
> **Análisis IA:** Librería open-source para mapas web con performance destacado. Competidor directo de Leaflet/Mapbox. Usado en GIS serio y aplicaciones geo de escala.

**Fortalezas:** _Performance en datasets geoespaciales grandes_ · _Soporte nativo para múltiples formatos (WMS, WFS, etc)_
...
![](https://img.shields.io/github/stars/sindresorhus/quick-look-plugins?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Mantenida por Sindre Sorhus (creíble), cubre use case específico bien_
...
![](https://img.shields.io/github/stars/kefranabg/readme-md-generator?style=flat-square&label=⭐) · aparece en 2 listas

A CLI that generates beautiful README.md files

> **Análisis IA:** CLI que genera README.md bonitos con secciones estándar. Acelera boilerplate inicial pero requiere completar a mano contenido específico del proyecto.

**Fortalezas:** _Genera README completo en segundos, estructura coherente_ · _Interactivo: guía paso a paso sin leer docs_
...
**Fortalezas:** _Soporte multi-formato (Docker, PyPI, Maven, npm, Helm) en una sola solución_ · _Scanning de vulnerabilidades en imágenes Docker incluido_
...
![](https://img.shields.io/github/stars/retextjs/retext?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Arquitectura extensible con plugins, muy modular_ · _API moderna y clara para procesamiento de texto_
...
> **Análisis IA:** IDE Rust by JetBrains con análisis, debugging, refactoring. Freemium para no-comercial. Para desarrolladores Rust que quieren IDE polished con intellisense robusto.

**Fortalezas:** _Intellisense y refactoring superior a VS Code + extensiones_ · _Debugging integrado sin configuración compleja_
...
![](https://img.shields.io/github/stars/boyter/scc?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Velocidad extrema (scans millones LOC)_ · _Múltiples lenguajes, salida flexible_
...
![](https://img.shields.io/github/stars/bitfield/script?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _API limpia para tareas comunes de shell_ · _Comunidad receptiva con code review detallado_
...
![](https://img.shields.io/github/stars/slint-ui/slint?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Performance nativa y compilación anticipada sin runtime pesado_ · _DSL declarativo intuitivo para diseño de UIs_
...
**Fortalezas:** _Soporte nativo de múltiples versiones y compiladores en paralelo_ · _Reproducibilidad garantizada en clusters_
...
![](https://img.shields.io/github/stars/sphinx-doc/sphinx?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Integración automática de docstrings Python_ · _Extensibilidad vía plugins_
...
![](https://img.shields.io/github/stars/tauri-apps/tauri?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Bundle 15-50MB vs 150+ Electron_ · _Memory-safe por diseño Rust_
...
![](https://img.shields.io/github/stars/alexpasmantier/television?style=flat-square&label=⭐) · aparece en 2 listas

A blazing fast general purpose fuzzy finder TUI

> **Análisis IA:** Fuzzy finder TUI escrito en Rust. Alternativa a fzf pero general purpose. Para devs que pasan tiempo en terminal. Resuelve búsqueda rápida de cualquier cosa.

**Fortalezas:** _Blazing fast, lag-free en datasets enormes_ · _Respeta stdin/stdout, compone bien en pipes_
...
**Fortalezas:** _Interfaz moderna y polida vs alternativas CLI puras_ · _Soporte multiplataforma incluyendo iOS/Android_
...
> **Análisis IA:** Editor Markdown minimalista con preview en vivo sincronizado. Para escritores técnicos y documentalistas que odian distracciones. Resuelve bien: escribir sin fricciones.

**Fortalezas:** _Preview en vivo verdaderamente fluido_ · _UI limpia sin botonería innecesaria_
...
**Fortalezas:** _Acceso web + desktop, gratis sin limitaciones_ · _Interfaz intuitiva para principiantes_
...
> **Análisis IA:** Terminal Rust con UX tipo app moderna. Promete velocidad y features como búsqueda, autocompletado. Competidor directo de iTerm2, Alacritty, Terminal.app.

**Fortalezas:** _Escrito en Rust, performance real_ · _UX pensada como app moderna, no como emulador retro_
...
![](https://img.shields.io/github/stars/water-run/treepp?style=flat-square&label=⭐) · aparece en 2 listas
...
**Fortalezas:** _Performance significativa vs tree nativo Windows_ · _Soporte .gitignore native_
...
![](https://img.shields.io/github/stars/sayanarijit/xplr?style=flat-square&label=⭐) · aparece en 2 listas

A hackable, minimal, fast TUI file explorer.

> **Análisis IA:** File explorer TUI minimalista y hackable en Rust. Para usuarios que quieren personalización extrema y performance. Resuelve la necesidad de navegación de archivos sin bloat.

**Fortalezas:** _Arquitectura modular permite extensiones vía Lua_ · _Extremadamente ligero, startup instantáneo_
...
![](https://img.shields.io/github/stars/sxyazi/yazi?style=flat-square&label=⭐) · aparece en 2 listas
