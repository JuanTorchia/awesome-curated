...
**強み:** _UI limpia e intuitiva_ · _Soporta múltiples formatos (ONNX, SavedModel, etc)_
...
**強み:** _Dashboard unificado para debugging de LLM pipelines_ · _Evaluación automática de outputs con criterios personalizados_
