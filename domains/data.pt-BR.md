...
**Evidence record:** [TOOLS.md](../TOOLS.md#gradio-gradio-app-gradio) · [data/latest.json](../data/latest.json)
...
**Evidence record:** [TOOLS.md](../TOOLS.md#matplotlib-matplotlib-matplotlib) · [data/latest.json](../data/latest.json)
...
**Why this is here:** Dagit UI moderna y debugging con linaje claro

**Evidence record:** [TOOLS.md](../TOOLS.md#dagster-dagster-io-dagster) · [data/latest.json](../data/latest.json)
...
**Why this is here:** Distributed parallel processing framework for Pandas and NumPy computations.

**Evidence record:** [TOOLS.md](../TOOLS.md#dask-dask-dask) · [data/latest.json](../data/latest.json)
